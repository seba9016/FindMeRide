...
<div class='container'>
    <label for='oldpwd' >Stare Hasło*:</label><br/>
...
<div class='container'>
    <label for='newpwd' >Nowe Hasło*:</label><br/>
...
// <![CDATA[
    ...
    frmvalidator.addValidation("oldpwd","req","Podaj swoję stare Hasło");
    
    frmvalidator.addValidation("newpwd","req","Podaj nowe Hasło");
