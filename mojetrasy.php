...
$sql = "SELECT t.ID, start , koniec, postoje, startdata, startczas FROM Trasy t  where t.UserID = $userid ";
...
$sql = "SELECT distinct t.ID FROM Trasy t where t.UserID = $userid";
$result = $conn->query($sql);
